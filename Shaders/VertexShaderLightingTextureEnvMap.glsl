...
/**
\file VertexShaderLightingTextureEnvMap.glsl
...
\param [out] emnormal --- vec3 transformed normal vector for the environment map.

\param [out] emposition --- vec3 transformed vertex for the environment map.
...
void main()
{
    ...
    emnormal = normalize(mat3(Model) * vnormal);
    emposition =(Model * vposition).xyz;
